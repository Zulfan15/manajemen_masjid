...
class KurbanSeeder extends Seeder
{
    ...
    {
        // 1. Setup Admin (Fallback jika belum ada)
        ...
        foreach ($jamaahSapi1 as $nama) {
            ...
            // GENERATE DISTRIBUSI (Jatah Shohibul Qurban) - 1/3 Bagian
            DistribusiKurban::create([
                ...
                'jenis_distribusi' => 'shohibul_qurban', // Updated Enum
        ...
        $pesertaSultan = PesertaKurban::create([
            ...
            'status_pembayaran' => 'lunas',
            'tanggal_pembayaran' => Carbon::now()->subDays(24),
            'created_by' => $adminId,
        ]);

        // Distribusi 1: Jatah Keluarga Sultan
        DistribusiKurban::create([
            'kurban_id' => $sapi2->id,
            ...
            'jenis_distribusi' => 'shohibul_qurban',
            'status_distribusi' => 'sudah_didistribusi',
        ...
        PesertaKurban::create([
            ...
            'status_pembayaran' => 'lunas',
            'tanggal_pembayaran' => Carbon::now()->subDays(14),
            'created_by' => $adminId,
        ]);
        ...
        DistribusiKurban::create([
            ...
            'jenis_distribusi' => 'fakir_miskin', // Anggap fakir miskin internal
            'status_distribusi' => 'sudah_didistribusi',
            'created_by' => $adminId,
        ]);
        ...
        $sapi4 = Kurban::create([
            ...
            'max_kuota' => 7,
            'harga_per_bagian' => 21700000 / 7,
            'catatan' => 'Menunggu jadwal penyembelihan jam 10:00',
            'created_by' => $adminId,
        ]);

        $hargaPerBagian4 = $sapi4->harga_per_bagian;
        
        PesertaKurban::create(['kurban_id' => $sapi4->id, 'nama_peserta' => "Kel. Gunawan", 'tipe_peserta' => 'keluarga', 'jumlah_jiwa' => 2, 'jumlah_bagian' => 2, 'nominal_pembayaran' => $hargaPerBagian4 * 2, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
        PesertaKurban::create(['kurban_id' => $sapi4->id, 'nama_peserta' => "Kel. Rina", 'tipe_peserta' => 'keluarga', 'jumlah_jiwa' => 2, 'jumlah_bagian' => 2, 'nominal_pembayaran' => $hargaPerBagian4 * 2, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
        PesertaKurban::create(['kurban_id' => $sapi4->id, 'nama_peserta' => "Kel. Sanusi", 'tipe_peserta' => 'keluarga', 'jumlah_jiwa' => 5, 'jumlah_bagian' => 3, 'nominal_pembayaran' => $hargaPerBagian4 * 3, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
        ...
        $sapi5 = Kurban::create([
            ...
            'status' => 'disiapkan',
            'max_kuota' => 7,
            'harga_per_bagian' => 19700000 / 7,
            'catatan' => 'Masih mencari 4 orang lagi.',
            'created_by' => $adminId,
        ]);

        $hargaPerBagian5 = $sapi5->harga_per_bagian;
        ...
        PesertaKurban::create(['kurban_id' => $sapi5->id, 'nama_peserta' => "Kel. Ibu Ani", 'tipe_peserta' => 'keluarga', 'jumlah_jiwa' => 2, 'jumlah_bagian' => 2, 'nominal_pembayaran' => $hargaPerBagian5 * 2, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
        ...
        // Kambing A (Selesai)
        $kambing1 = Kurban::create(['nomor_kurban' => 'KB-2025-006', 'jenis_hewan' => 'kambing', 'berat_badan' => 30, 'harga_hewan' => 3000000, 'total_biaya' => 3100000, 'status' => 'selesai', 'max_kuota' => 1, 'harga_per_bagian' => 3100000, 'tanggal_persiapan' => Carbon::now()->subDays(10), 'tanggal_penyembelihan' => Carbon::now()->subDays(2), 'created_by' => $adminId]);
        $pk1 = PesertaKurban::create(['kurban_id' => $kambing1->id, 'nama_peserta' => 'Ustadz Solmed', 'jumlah_bagian' => 1, 'nominal_pembayaran' => 3100000, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
        DistribusiKurban::create(['kurban_id' => $kambing1->id, 'peserta_kurban_id' => $pk1->id, 'penerima_nama' => 'Ust Solmed', 'berat_daging' => 3, 'estimasi_harga' => 300000, 'jenis_distribusi' => 'shohibul_qurban', 'status_distribusi' => 'sudah_didistribusi', 'created_by' => $adminId]);

        // Domba B (Siap Sembelih)
        $domba1 = Kurban::create(['nomor_kurban' => 'KB-2025-007', 'jenis_hewan' => 'domba', 'berat_badan' => 45, 'harga_hewan' => 4500000, 'total_biaya' => 4600000, 'status' => 'siap_sembelih', 'max_kuota' => 1, 'harga_per_bagian' => 4600000, 'tanggal_persiapan' => Carbon::now()->subDays(5), 'created_by' => $adminId]);
        PesertaKurban::create(['kurban_id' => $domba1->id, 'nama_peserta' => 'Habib Jafar', 'jumlah_bagian' => 1, 'nominal_pembayaran' => 4600000, 'status_pembayaran' => 'lunas', 'tanggal_pembayaran' => now(), 'created_by' => $adminId]);
    
        echo "\n✅ Seeding Selesai: 7 Data Kurban dengan berbagai skenario (Warga, Sultan, Perusahaan) berhasil dibuat.\n";
    }
}