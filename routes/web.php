...
// [TAMBAHAN] Import Controller Modul 8
...
// =========================================================================
// 1. PUBLIC ROUTES (Halaman Depan - Bisa Diakses Tanpa Login)
// =========================================================================
// Akses di: http://127.0.0.1:8000/info-masjid
Route::get('/info-masjid', [InformasiController::class, 'publicIndex'])->name('public.home');
Route::get('/info-masjid/{slug}', [InformasiController::class, 'publicShow'])->name('public.info.show');
...
Route::middleware('auth')->group(function () {
    ...
    // =========================================================================
    // [MODIFIKASI] Module 8: Information & Announcements
    // =========================================================================
    Route::middleware(['module.access:informasi'])->prefix('informasi')->name('informasi.')->group(function () {
        ...
        Route::post('/{id}/broadcast', [InformasiController::class, 'broadcast'])->name('broadcast');
    });
