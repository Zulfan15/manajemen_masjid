...
<?php $__env->startSection('title', 'Tambah Aktivitas Harian'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Aktivitas Harian</h1>
            <p class="text-gray-600 mt-1">Catat aktivitas harian pengurus masjid</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="<?php echo e(route('takmir.aktivitas.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $pengurusList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengurus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($pengurus->id); ?>" <?php echo e(old('takmir_id') == $pengurus->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-medium text-blue-800">Anda sedang mencatat aktivitas atas nama:</p>
                        <p class="text-sm text-blue-700"><?php echo e($takmir->nama); ?> - <?php echo e($takmir->jabatan); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="Ibadah" <?php echo e(old('jenis_aktivitas') == 'Ibadah' ? 'selected' : ''); ?>>Ibadah</option>
                    <option value="Kebersihan" <?php echo e(old('jenis_aktivitas') == 'Kebersihan' ? 'selected' : ''); ?>>Kebersihan</option>
                    <option value="Administrasi" <?php echo e(old('jenis_aktivitas') == 'Administrasi' ? 'selected' : ''); ?>>Administrasi</option>
                    <option value="Pengajaran" <?php echo e(old('jenis_aktivitas') == 'Pengajaran' ? 'selected' : ''); ?>>Pengajaran</option>
                    <option value="Pembinaan" <?php echo e(old('jenis_aktivitas') == 'Pembinaan' ? 'selected' : ''); ?>>Pembinaan</option>
                    <option value="Keuangan" <?php echo e(old('jenis_aktivitas') == 'Keuangan' ? 'selected' : ''); ?>>Keuangan</option>
                    <option value="Sosial" <?php echo e(old('jenis_aktivitas') == 'Sosial' ? 'selected' : ''); ?>>Sosial</option>
                    <option value="Lainnya" <?php echo e(old('jenis_aktivitas') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                </select>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Jelaskan secara detail aktivitas yang dilakukan..."><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="durasi_jam" id="durasi_jam" 
                       ...
                       value="<?php echo e(old('durasi_jam')); ?>"
...
unset($__errorArgs, $__bag); ?>
                <p class="text-gray-500 text-sm mt-1">
                    <i class="fas fa-info-circle"></i> Opsional. Format: JPG, PNG, JPEG. Maksimal 2MB
                </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\!KULIAH\!SEM7\menpro\manajemen_masjid\resources\views/modules/takmir/aktivitas/create.blade.php ENDPATH**/ ?>