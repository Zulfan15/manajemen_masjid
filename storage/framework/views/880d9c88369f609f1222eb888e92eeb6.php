                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <?php if($item->thumbnail): ?>
                            <img src="<?php echo e(asset('storage/'.$item->thumbnail)); ?>" class="w-16 rounded">
                        <?php endif; ?>
                    </td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="<?php echo e(route('informasi.berita.edit', $item->id)); ?>"
                           class="text-blue-600 mx-1"><i class="fas fa-edit"></i></a>

                        <form action="<?php echo e(route('informasi.berita.destroy',$item->id)); ?>"
...
<?php /**PATH C:\Users\ACER\Downloads\Manpro Masjid\resources\views/modules/informasi/partials/table_berita.blade.php ENDPATH**/ ?>