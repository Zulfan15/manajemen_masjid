...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('keuangan.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="start_date" value="<?php echo e(date('Y-m-01')); ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Tanggal Akhir</label>
                    <input type="date" class="form-control" id="end_date" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\manajemen_masjid\manajemen_masjid\manajemen_masjid-main\resources\views/modules/keuangan/laporan/index.blade.php ENDPATH**/ ?>