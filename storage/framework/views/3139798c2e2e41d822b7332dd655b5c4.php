...
<div class="container mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <?php if(auth()->user()->canManageKeuangan()): ?>
                <button onclick="window.location.href='<?php echo e(route('pemasukan.create')); ?>'" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-lg p-6 shadow-sm hover:shadow-md transition">
                    ...
                    <div class="flex space-x-2">
                        <button onclick="window.location.href='<?php echo e(route('pemasukan.index')); ?>'" 
                ...
                <div class="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-6 shadow-sm hover:shadow-md transition">
                    ...
                    <button onclick="window.location.href='<?php echo e(route('laporan.index')); ?>'" 
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="<?php echo e(route('pemasukan.index')); ?>?filter=today" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\manajemen_masjid\manajemen_masjid\manajemen_masjid-main\resources\views/modules/keuangan/index.blade.php ENDPATH**/ ?>