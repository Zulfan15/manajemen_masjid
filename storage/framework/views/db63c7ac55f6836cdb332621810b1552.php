    ...
    <div class="p-4">
        ...
        <nav>
            ...
            <?php if(auth()->user()->hasRole('super_admin')): ?>
                ...
                <!-- TOMBOL PEMASUKAN USER - BARU DITAMBAHKAN -->
                <a href="<?php echo e(route('users.income')); ?>" 
                   class="flex items-center px-4 py-3 text-gray-700 hover:bg-green-50 hover:text-green-700 rounded transition <?php echo e(request()->routeIs('users.income') ? 'bg-green-100 text-green-700' : ''); ?>">
                    <i class="fas fa-user-plus w-6"></i>
                    <span>Pemasukan User</span>
                </a>
            <?php endif; ?>

            <?php if(auth()->user()->hasRole('jamaah')): ?>
                <hr class="my-4">
...
</aside><?php /**PATH D:\xampp\htdocs\manajemen_masjid\manajemen_masjid-main\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>