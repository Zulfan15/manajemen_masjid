...
<?php $__env->startSection('title', 'Absensi Kegiatan'); ?>
<?php $__env->startSection('content'); ?>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex items-start justify-between mb-6">
                <div>
                    ...
                    <p class="text-lg text-gray-700"><?php echo e($kegiatan->nama_kegiatan); ?></p>
                    <p class="text-sm text-gray-600 mt-1">
                        <i class="fas fa-calendar mr-1"></i><?php echo e($kegiatan->tanggal_mulai->format('d F Y')); ?>

                        <i class="fas fa-clock ml-3 mr-1"></i><?php echo e(date('H:i', strtotime($kegiatan->waktu_mulai))); ?> WIB
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p class="text-2xl font-bold text-blue-700"><?php echo e($kegiatan->peserta->count()); ?></p>
                </div>
                <div class="bg-green-50 p-4 rounded-lg">
                    <p class="text-sm text-green-600 mb-1">Hadir</p>
                    <p class="text-2xl font-bold text-green-700"><?php echo e($kegiatan->absensi()->hadir()->count()); ?></p>
                </div>
                <div class="bg-red-50 p-4 rounded-lg">
                    <p class="text-sm text-red-600 mb-1">Tidak Hadir</p>
                    <p class="text-2xl font-bold text-red-700"><?php echo e($kegiatan->absensi()->tidakHadir()->count()); ?></p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p class="text-sm text-gray-600 mb-1">Belum Absen</p>
                    <p class="text-2xl font-bold text-gray-700">
                        <?php echo e($kegiatan->peserta->count() - $kegiatan->absensi->count()); ?>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if($peserta->absensi): ?>
                                            <span
                                                class="px-3 py-1 <?php echo e($peserta->absensi->getStatusBadgeClass()); ?> text-sm rounded-full">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600">
                                        <?php if($peserta->absensi): ?>
                                            <?php echo e($peserta->absensi->waktu_absen->format('d M Y H:i')); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <button
                                            onclick="openAbsensiModal(<?php echo e($peserta->id); ?>, '<?php echo e($peserta->nama_peserta); ?>', '<?php echo e($peserta->absensi->status_kehadiran ?? ''); ?>')"
                                            class="px-3 py-1 bg-orange-600 text-white text-sm rounded hover:bg-orange-700">
                                            <i class="fas fa-check mr-1"></i>
                                            <?php echo e($peserta->absensi ? 'Ubah' : 'Catat'); ?>
    ...
    <div id="absensiModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
            ...
            <form id="absensiForm" action="<?php echo e(route('kegiatan.absensi.store', $kegiatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Bayu\Kuliah\Semester 7\Menpro\Kodingan\manajemen_masjid\resources\views/modules/kegiatan/absensi.blade.php ENDPATH**/ ?>