        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-800">
                    <i class="fas fa-plus-circle text-green-700 mr-2"></i>Tambah Kegiatan Baru
                </h1>
                <p class="text-gray-600 mt-2">Tambahkan kegiatan atau event baru untuk masjid</p>
            </div>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="rutin" <?php echo e(old('jenis_kegiatan') == 'rutin' ? 'selected' : ''); ?>>Rutin</option>
                            <option value="insidental" <?php echo e(old('jenis_kegiatan') == 'insidental' ? 'selected' : ''); ?>>
                                Insidental</option>
                            <option value="event_khusus" <?php echo e(old('jenis_kegiatan') == 'event_khusus' ? 'selected' : ''); ?>>
                                Event Khusus</option>
                        </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aji Katab\KULIAH\SEMESTER 7\MANAJEMEN PROYEK\manajemen_masjid\resources\views/modules/kegiatan/create.blade.php ENDPATH**/ ?>