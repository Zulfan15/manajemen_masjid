    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex gap-2 flex-wrap">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('takmir.aktivitas.index')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200 flex items-center">
                    <i class="fas fa-clipboard-list mr-2"></i>Aktivitas Harian
                </a>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('takmir.view')): ?>
                    <a href="<?php echo e(route('takmir.pemilihan.index')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition duration-200 flex items-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backup\tahun ajaran 4-1 smester 7\ManPro\Manajemen Masjid\manajemen_masjid\resources\views/modules/takmir/index.blade.php ENDPATH**/ ?>