...
<?php $__env->startSection('title', 'Manajemen Takmir'); ?>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">
                    <i class="fas fa-user-tie text-green-700 mr-2"></i>Manajemen Takmir
                </h1>
                <p class="text-gray-600 mt-2">Kelola data takmir masjid</p>
            </div>
