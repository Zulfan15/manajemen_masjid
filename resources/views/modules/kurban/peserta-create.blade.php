        ...
        <form method="POST" action="{{ route('kurban.peserta.store', $kurban) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.25" name="jumlah_bagian" value="{{ old('jumlah_bagian', 1) }}" min="0.25" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Contoh: 1, 1.5, 2" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" name="nominal_pembayaran" value="{{ old('nominal_pembayaran') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Contoh: 5000000" required>
