    ...
    <div class="container mx-auto">
                ...
                @if(auth()->user()->hasPermission('inventaris.create'))
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('inventaris.aset.index') }}"
                            ...
                            <i class="fas fa-list mr-2"></i> Data Aset
                        </a>
                    </div>
                @endif
            </div>
                ...
                @forelse(($asetPerKategori ?? collect()) as $row)
                    <div class="flex items-center mb-3">
                        ...
                        <div class="flex-1 bg-gray-100 h-2 rounded">
                            <div class="h-2 rounded bg-green-600" style="width: {{ ($row->total / $maxKategori) * 100 }}%">
                            </div>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center justify-center h-full min-h-[150px]">
                    <div class="w-12 h-12 rounded-full bg-teal-100 flex items-center justify-center mb-3">
                        <i class="fas fa-calendar-check text-teal-700"></i>
                    </div>
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Jadwal Perawatan</h3>
                    <p class="text-xs text-gray-500 mb-3 text-center">
                        Kelola jadwal perawatan aset inventaris masjid.
                    </p>
