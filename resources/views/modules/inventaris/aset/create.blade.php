                    ...
                    <form action="{{ route('inventaris.aset.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <label class="flex flex-col">
                                ...
                                <input name="nama_aset" placeholder="Contoh: Karpet Sholat" class="h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 text-sm text-gray-900
                            ...
                            <label class="flex flex-col">
                                ...
                                <select name="kategori" class="h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 text-sm text-gray-900
                                               focus:outline-0 focus:ring-2 focus:ring-emerald-700/30">
                            ...
                            {{-- Jenis Aset (radio sesuai revisi terbaru) --}}
                            <div class="flex flex-col">
                                <span class="text-gray-800 text-sm font-medium pb-2">Jenis Aset</span>
                                <div class="grid grid-cols-2 gap-3">
                                    <label
                                        class="flex items-center gap-2 h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4">
                            ...
                            <label class="flex flex-col">
                                ...
                                <select name="status" class="h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 text-sm text-gray-900
                                               focus:outline-0 focus:ring-2 focus:ring-emerald-700/30">
                            ...
                            <label class="flex flex-col">
                                ...
                                <input type="date" name="tanggal_perolehan" class="h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 text-sm text-gray-900
                                              focus:outline-0 focus:ring-2 focus:ring-emerald-700/30" />
                            </label>

                            {{-- Harga Perolehan --}}
                            <label class="flex flex-col">
                                <span class="text-gray-800 text-sm font-medium pb-2">Harga Perolehan (Rp)</span>
                                <input type="number" name="harga_perolehan" min="0" placeholder="0" class="h-12 rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 text-sm text-gray-900
                                              focus:outline-0 focus:ring-2 focus:ring-emerald-700/30" />
                                <span class="text-xs text-emerald-600 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>Akan otomatis tercatat sebagai Pengeluaran
                                </span>
                            </label>

                            {{-- Lokasi Barang (textarea sesuai revisi terbaru) --}}
                            <label class="flex flex-col md:col-span-2">
                                <span class="text-gray-800 text-sm font-medium pb-2">Lokasi Barang</span>
                                <textarea name="lokasi" rows="3" placeholder="Contoh: Gudang utama, Lantai 2" class="rounded-lg border border-gray-300 bg-[#f6f8f7] px-4 py-3 text-sm text-gray-900
                            ...
                            <div class="flex flex-col md:col-span-2">
                                ...
                                <label class="flex flex-col items-center justify-center w-full h-44 border-2 border-dashed border-gray-300 rounded-lg
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center">
                                        <div
                                            class="h-10 w-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500">
