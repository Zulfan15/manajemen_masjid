...
@section('title', 'Tambah Pemeriksaan Kondisi')
    ...
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                ...
                Tambah Pemeriksaan Kondisi
            </h1>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            <form action="{{ route('inventaris.kondisi.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="kondisi" id="kondisi" required
                            ...
                            @foreach($kondisiOptions as $value => $label)
                                <option value="{{ $value }}" {{ old('kondisi') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="petugas_pemeriksa" id="petugas_pemeriksa"
                            value="{{ old('petugas_pemeriksa') }}" placeholder="Isi jika bukan user sistem"
