...
@section('content')
    <div class="container mx-auto">
        <div class="bg-white rounded-lg shadow p-6 max-w-2xl mx-auto">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">
                        <i class="fas fa-user-plus text-blue-600 mr-2"></i>Tambah Muzakki
                    </h1>
                    <p class="text-gray-600 mt-1">Daftarkan pemberi zakat baru</p>
                </div>
            ...
            <form action="{{ route('zis.muzakki.store') }}" method="POST" class="space-y-4">
                @csrf
