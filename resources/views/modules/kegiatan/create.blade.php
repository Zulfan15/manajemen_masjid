                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenis_kegiatan" required
                            ...
                            <option value="rutin" {{ old('jenis_kegiatan') == 'rutin' ? 'selected' : '' }}>Rutin</option>
                            <option value="insidental" {{ old('jenis_kegiatan') == 'insidental' ? 'selected' : '' }}>
                                Insidental</option>
                            <option value="event_khusus" {{ old('jenis_kegiatan') == 'event_khusus' ? 'selected' : '' }}>
                                Event Khusus</option>
                        </select>
